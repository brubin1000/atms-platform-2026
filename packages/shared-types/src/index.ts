...
export interface AdvanceForm {
  ...
  guestList?: { spots?: number; submissionEmail?: string; deadline?: string | Date };
  visaRequired?: boolean;
  coiRequired?: boolean;
  passportRequired?: boolean;
  runOfShow?: string;
  guarantee?: number;
  depositSchedule?: Array<{ dueDate?: string | Date; amount?: number; status?: string; note?: string }>;
  wireInfo?: { bankName?: string; accountNumber?: string; routingNumber?: string; swift?: string };
  createdAt?: string;
  updatedAt?: string;
}
...
export interface GeminiParseResult {
  ...
  groundTransport: ParsedField<Array<{ from: string; to: string; pickupTime?: string | Date; type?: string }>>;
